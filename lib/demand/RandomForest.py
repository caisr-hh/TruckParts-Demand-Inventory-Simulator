...
class RandomForest:
    def __init__(self, data_dir: str, feature_series):
        ...
        self.hold_folder = os.path.join(self.data_dir, "RandomForest")
    ...
    def regression_comprehensive_feature_comparison(self, start_date, train_period, 
        ...
        for key in FEATURES_DICT:
            ...
            if not opt:
                ...
                rf = RandomForestRegressor(n_estimators=opt.best_params['n_estimators'],
            ...
            #- offline forecasting -#
            test_off = test.copy()
            test_off['prediction'] = rf.predict(X_test)
